        ...
        <div className="loading-card">
          <div className="loading-animation">
            ...
            <p className="loading-subtext">
              We are analyzing your profile and job description.
            </p>
          </div>
          <div className="loading-steps">
            <p>Reading profile details</p>
            <p>Matching with job requirements</p>
            <p>Preparing technical and behavioral roadmap</p>
          </div>
        </div>
      </main>
    );
          ...
          <div className="panel panel--right">
            ...
            <div className="upload-section">
              ...
              <label className="dropzone" htmlFor="resume">
                ...
                {resumeName && (
                  <div className="resume-filename">Selected: {resumeName}</div>
                )}
              </label>
            </div>
